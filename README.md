...
This hackathon is designed for AI Engineers, Developers, Solution Architects and who are eager to learn how to harness the power of Azure OpenAI and build next gen intelligent apps.
